...
SELECT * FROM tb_produtos INNER JOIN  tb_categorias ON tb_categoria_id =tb_categoria.id;
SELECT * FROM tb_produtos INNER JOIN  tb_usuarios ON tb_usuario_id =tb_usuarios.id;

SELECT * FROM tb_produtos INNER JOIN  tb_categorias ON tb_categoria_id =tb_categoria.id
INNER JOIN  tb_usuarios ON tb_usuario_id =tb_usuarios.id;
